...
Firstly, the Question table, which was originally one of the core tables and was intended to store all questions, instead went through changes to more appropriately reflect our decision to rework this table as a table of frequently used questions only.

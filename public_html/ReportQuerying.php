<?php        
	...
	$dbc = mysqli_connect($dbhost, $dbuser, $dbpass, $dbname);
        ...
        //Gets the camp ID and survey name 
        $CampID = $data->CampID;
        ...
        $MatchedStudIDs = [];        
        //Sets up the query statement for filtering based on demographic info 
        ...
        $PreSurveyID;
        $PostSurveyID;
        //Gets the student responses for both pre and post 
        if($SurveyName == "Both"){
                //Determines which ID is a pre and if the other is the post  
                ...
                if (mysqli_num_rows($result) > 0) {
                    while($row = mysqli_fetch_assoc($result)) {
                        //ID is found in the list of IDs filtered by demographic info add student 
